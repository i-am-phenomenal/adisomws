...
export default class CoronaBlogView extends Component {
    constructor(props) {
        super(props);
        this.state = {}
    }
...
This is the catastrophe that philanthropists used to dream of. The future that all Hollywood filmmakers dreaded. This is the rotten premise of our glittery hopes and aspirations to preserve the world. You might assume me to be a pessimist, but I only claim to be a realist. Now isn’t this real?
The deadly cloak of a fatal virus covers the globe. COVID-19, a variant of the pandemic causing Corona Virus, has claimed countless lives till now, and it does not seem to be stopping any time soon. I visualize this disease as that shapeless monstrous waft of air, that prevented you from sleeping at night as you peered at the open window, imagining a ghostly, inhuman creature ready to take your life. It is always standing at the foot of your bed, and as you figure out whether to give in to it or against it, it has already made a home in your delusions.
                           </p>
                           <p> “I should probably just sleep with mom and dad.” </p>
                           <p>
                           But that reminds me: Isolation is the only reality that prevails now. Amiability and closure, the core identifiers of human qualities are targeted here. Mass lockdowns, quarantines are prevalent everywhere. They have to be. But somehow, if you still didn’t catch the picture, let me paint it a bit more vivid for you now.
                           </p>
                           <p>Grey clouds taint the sky now. It was extremely sunny yesterday, but rain poured hard today. Must be that global warming hypocrisy everyone keeps talking about. But I don’t know, I don’t care. Day 62 of the lockdown approaches as I get up from bed to follow the same monotony that I got accustomed to in my small living space. I scroll through the different apps, but the same garbage. On different occasions, but with the same mindset . The calendar shows a different day, but they all have the same outlook. The streets are dead silent, not a single cry of any bird or a hawk in sight. The Local Municipal Corporations, PETA and other Animal Care Organizations joined hands together to shelter in street animals after different variants of the Coronavirus, that infect cattle, mice, cats, dogs, horses, etc., started becoming rampant. Hence, the motionless streets. The death toll is astonishingly high, number of people affected even more so. </p>
